...
import yimer.enginneindustries.bluetv.FocusType
...
class CustomListRowPresenter(var mContext: Context?,
        ...
        when(mFocusType){
            FocusType.START -> {
                ...
                vHorizontalGridView?.run{
                    ...
                    windowAlignmentOffset = resources.getDimensionPixelSize(androidx.leanback.R.dimen.lb_browse_padding_start)
            ...
            vHorizontalGridView?.run{
                ...
                addOnChildViewHolderSelectedListener(object: OnChildViewHolderSelectedListener(){
                    override fun onChildViewHolderSelected(
                        ...
                        Log.d(TAG, "parent is null or not??? ${false}")
    ...
    fun notifyData() {
        ...
        if (mListRow != null && vHorizontalGridView!=null) {
            ...
            Log.e(TAG, "adapter is null or not?? ${false}")
